...
var PassageStoryConfig = Passage.extend({
  defaults: {
    ...
    mc_invalid_alpha_first_name_oip: 0,
  ...
  template: _.template('<tw-passageStoryConfigData pid="<%- id %>" ' +
    ...
    'mc_ask_beta_0_oip="<%- mc_ask_beta_0_oip %>" ' +
    ...
    'mc_invalid_alpha_first_name_oip="<%- mc_invalid_alpha_first_name_oip %>"' +
  ...
  publish: function(id) {
    return this.template({
      ...
      mc_ask_beta_0_oip: this.get('mc_ask_beta_0_oip'),
      ...
      mc_invalid_alpha_first_name_oip: this.get('mc_invalid_alpha_first_name_oip'),
